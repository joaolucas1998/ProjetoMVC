...
<body>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <br>
            <a href="/<?PHP echo FOLDER; ?>/?controller=Professor&acao=salvar" class="btn btn-info">Cadastrar professor</a>
            <br>
            <br>
                ...
                <tbody>
                    <?php foreach ($professores as $id => $professorAtual) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="/<?php echo FOLDER; ?>?controller=Professor&acao=editar&id=<?php echo $professorAtual['id']; ?>" class="btn btn-info">Editar</a>
